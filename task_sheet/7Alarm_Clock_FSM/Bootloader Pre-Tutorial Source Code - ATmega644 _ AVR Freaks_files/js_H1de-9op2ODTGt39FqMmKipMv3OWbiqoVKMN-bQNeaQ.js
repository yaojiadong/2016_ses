...
Drupal.behaviors.quoteHighlighted = {
  attach: function(context, settings) {
    ...
    .click(function(e) {
      ...
      var selected = getSelectedText(quote_post);
     ...
     */
    function getSelectedText(quote_post) {
      ...
      if (text_selection) {
        var selection_post = $(text_selection.anchorNode).closest('.forum-post');
        if (selection_post.attr('id') == quote_post.attr('id')) {
          return text_selection.toString();
        }
        else {
          return '';
        }
